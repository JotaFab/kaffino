...
export const Login: React.FC = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-isabeline">
            <div className="bg-white max-w-sm shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <h2 className="text-2xl font-bold mb-6 text-licorice">Acceder</h2>
                <p className="text-gray-700 text-sm italic mb-4">Ingresa tu correo electrónico para recibir una clave unica.</p>
